...
# static fields
.field private static final a:Landroidx/core/graphics/f;

.field private static final b:Lo/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/graphics/d;->b:Lo/e;
...
.method public static c(Landroid/content/Context;Landroidx/core/content/res/e$b;Landroid/content/res/Resources;ILjava/lang/String;IILandroidx/core/content/res/h$b;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 13
    ...
    invoke-virtual {v1, v3, v2}, Landroidx/core/content/res/h$b;->d(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-static/range {p8 .. p8}, Landroidx/core/content/res/h$b;->e(Landroid/os/Handler;)Landroid/os/Handler;

    move-result-object v11

    new-instance v12, Landroidx/core/graphics/d$a;

    invoke-direct {v12, v1}, Landroidx/core/graphics/d$a;-><init>(Landroidx/core/content/res/h$b;)V
    ...
    invoke-virtual {v1, v0, v2}, Landroidx/core/content/res/h$b;->d(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {v1, v3, v2}, Landroidx/core/content/res/h$b;->c(ILandroid/os/Handler;)V

    :cond_7
    :goto_3
    if-eqz v0, :cond_8

    sget-object v1, Landroidx/core/graphics/d;->b:Lo/e;
    ...
    invoke-virtual {v1, v2, v0}, Lo/e;->d(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/core/graphics/f;->c(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    sget-object p2, Landroidx/core/graphics/d;->b:Lo/e;

    invoke-virtual {p2, p1, p0}, Lo/e;->d(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static f(Landroid/content/res/Resources;ILjava/lang/String;II)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroidx/core/graphics/d;->b:Lo/e;
    ...
    invoke-virtual {v0, p0}, Lo/e;->c(Ljava/lang/Object;)Ljava/lang/Object;

...
.method public final b(Ls/e;Lt/b$a;)V
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->a0()Z
    ...
    :cond_1
    invoke-virtual/range {p1 .. p1}, Ls/e;->I()Ls/e;
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->q()Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->e0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->z()I
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->f0()Z
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->P()I
    ...
    invoke-static {v9, v11}, Ls/j;->b(II)Z
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->n()I

    move-result v9

    if-ne v8, v9, :cond_1a

    invoke-virtual/range {p1 .. p1}, Ls/e;->d0()Z

    move-result v8

    if-nez v8, :cond_1a

    invoke-virtual/range {p1 .. p1}, Ls/e;->A()I
    ...
    invoke-virtual/range {p1 .. p1}, Ls/e;->B()I
    ...
    iput v0, v2, Lt/b$a;->e:I

    invoke-virtual/range {p1 .. p1}, Ls/e;->v()I

    move-result v0

    iput v0, v2, Lt/b$a;->f:I

    invoke-virtual/range {p1 .. p1}, Ls/e;->n()I

    move-result v0

    iput v0, v2, Lt/b$a;->g:I
    ...
    :goto_10
    sget-object v11, Ls/e$b;->m:Ls/e$b;

    if-eq v4, v11, :cond_1e

    sget-object v12, Ls/e$b;->j:Ls/e$b;
    ...
    invoke-virtual {v9, v8, v6, v7}, Landroidx/constraintlayout/widget/j;->o(Ls/k;II)V
    ...
    :goto_18
    invoke-virtual {v1, v6, v7}, Ls/e;->F0(II)V
    ...
    invoke-static {v0}, Landroidx/constraintlayout/widget/ConstraintLayout;->b(Landroidx/constraintlayout/widget/ConstraintLayout;)I

    move-result v0

    const/4 v6, 0x1

    invoke-static {v0, v6}, Ls/j;->b(II)Z
    ...
    :goto_20
    iget v0, v2, Lt/b$a;->c:I

    if-ne v15, v0, :cond_33

    iget v0, v2, Lt/b$a;->d:I
    ...
    :goto_22
    iput-boolean v0, v2, Lt/b$a;->i:Z

    iget-boolean v0, v13, Landroidx/constraintlayout/widget/ConstraintLayout$b;->Y:Z
    ...
    :cond_35
    iput v15, v2, Lt/b$a;->e:I

    iput v5, v2, Lt/b$a;->f:I

    iput-boolean v6, v2, Lt/b$a;->h:Z

    iput v14, v2, Lt/b$a;->g:I

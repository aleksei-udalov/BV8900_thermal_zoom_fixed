...
.field l:Landroidx/appcompat/view/menu/e;

.field m:Landroidx/appcompat/view/menu/ExpandedMenuView;
...
.field r:Landroidx/appcompat/view/menu/c$a;
...
.method public constructor <init>(II)V
    ...
    iput p2, p0, Landroidx/appcompat/view/menu/c;->o:I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->j:Landroid/content/Context;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->k:Landroid/view/LayoutInflater;
...
.method public a(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/c;->q:Landroidx/appcompat/view/menu/j$a;
...
.method public b(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    iget v1, p0, Landroidx/appcompat/view/menu/c;->o:I

    invoke-direct {v0, p1, v1}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroidx/appcompat/view/menu/c;->j:Landroid/content/Context;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/c;->j:Landroid/content/Context;

    if-eqz v0, :cond_1

    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->j:Landroid/content/Context;

    iget-object v0, p0, Landroidx/appcompat/view/menu/c;->k:Landroid/view/LayoutInflater;
    ...
    :cond_1
    :goto_1
    iput-object p2, p0, Landroidx/appcompat/view/menu/c;->l:Landroidx/appcompat/view/menu/e;
...
.method public e(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/k;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/c;->m:Landroidx/appcompat/view/menu/ExpandedMenuView;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->m:Landroidx/appcompat/view/menu/ExpandedMenuView;

    iget-object p1, p0, Landroidx/appcompat/view/menu/c;->r:Landroidx/appcompat/view/menu/c$a;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->r:Landroidx/appcompat/view/menu/c$a;

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/c;->m:Landroidx/appcompat/view/menu/ExpandedMenuView;
    ...
    :cond_1
    iget-object p0, p0, Landroidx/appcompat/view/menu/c;->m:Landroidx/appcompat/view/menu/ExpandedMenuView;
...
.method public k(Landroidx/appcompat/view/menu/j$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/c;->q:Landroidx/appcompat/view/menu/j$a;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/c;->l:Landroidx/appcompat/view/menu/e;

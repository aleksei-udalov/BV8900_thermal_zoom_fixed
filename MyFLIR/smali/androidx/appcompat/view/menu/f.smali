...
.field l:Landroidx/appcompat/view/menu/c;
...
.method public constructor <init>(Landroidx/appcompat/view/menu/e;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/e;
...
.method public a(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_1
    iget-object p0, p0, Landroidx/appcompat/view/menu/f;->m:Landroidx/appcompat/view/menu/j$a;
...
.method public c()V
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/app/b;
...
.method public d(Landroid/os/IBinder;)V
    ...
    iput-object v2, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v2, p0}, Landroidx/appcompat/view/menu/c;->k(Landroidx/appcompat/view/menu/j$a;)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/e;

    iget-object v3, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v2, v3}, Landroidx/appcompat/view/menu/e;->b(Landroidx/appcompat/view/menu/j;)V

    iget-object v2, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v2}, Landroidx/appcompat/view/menu/c;->c()Landroid/widget/ListAdapter;
    ...
    invoke-virtual {v2, v0}, Landroidx/appcompat/app/b$a;->l(Ljava/lang/CharSequence;)Landroidx/appcompat/app/b$a;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/app/b;

    invoke-virtual {v0, p0}, Landroid/app/Dialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/app/b;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/e;

    iget-object p0, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/c;

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/c;->c()Landroid/widget/ListAdapter;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/f;->l:Landroidx/appcompat/view/menu/c;

    iget-object p0, p0, Landroidx/appcompat/view/menu/f;->j:Landroidx/appcompat/view/menu/e;

    const/4 v0, 0x1

    invoke-virtual {p1, p0, v0}, Landroidx/appcompat/view/menu/c;->a(Landroidx/appcompat/view/menu/e;Z)V
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/f;->k:Landroidx/appcompat/app/b;

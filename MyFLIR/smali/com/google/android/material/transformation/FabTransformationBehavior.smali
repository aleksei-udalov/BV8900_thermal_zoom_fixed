...
.method private L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ll4/i;Ll4/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ll4/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ll4/i;FF)F
...
.method private N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;

    const-string p1, "translationXCurveUpwards"

    invoke-virtual {p0, p1}, Ll4/h;->e(Ljava/lang/String;)Ll4/i;

    move-result-object p0

    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;
...
.method private O(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ll4/j;)F
...
.method private P(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ll4/j;)F
...
.method private Q(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    .locals 2
...
.method private R(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    .locals 2
...
.method private S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ll4/i;FF)F
    .locals 6

    invoke-virtual {p2}, Ll4/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Ll4/i;->d()J

    move-result-wide v2

    iget-object p0, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;
    ...
    invoke-virtual {p2}, Ll4/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p0}, Ll4/a;->a(FFF)F
...
.method private U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object p3, Ll4/d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p1, Ll4/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p1, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;
...
.method private V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {p2, p0}, Lo4/d;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p0, Lo4/d$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p1, Lo4/d$d;->a:Landroid/util/Property;
...
.method private W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ll4/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    ...
    invoke-virtual {v1, v0}, Ll4/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p0}, Ll4/i;->a(Landroid/animation/Animator;)V
...
.method private X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p2}, Landroidx/core/view/u;->u(Landroid/view/View;)F

    move-result p0

    invoke-static {p1}, Landroidx/core/view/u;->u(Landroid/view/View;)F
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    iget-object v1, v10, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {v8, v0, v9, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Ll4/j;)F

    move-result v1

    iget-object v2, v10, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {v8, v0, v9, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Ll4/j;)F
    ...
    iget-object v0, v10, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Ll4/h;->e(Ljava/lang/String;)Ll4/i;
    ...
    invoke-direct {v0, v1, v11, v13}, Lo4/d$e;-><init>(FFF)V

    invoke-interface {v12, v0}, Lo4/d;->setRevealInfo(Lo4/d$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v12}, Lo4/d;->getRevealInfo()Lo4/d$e;

    move-result-object v0

    iget v0, v0, Lo4/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Lv4/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v12, v1, v11, v0}, Lo4/a;->a(Lo4/d;FFF)Landroid/animation/Animator;

    move-result-object v10

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v8, v12}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lo4/d;)V

    invoke-virtual {v10, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Ll4/i;->c()J
    ...
    iget v6, v0, Lo4/d$e;->c:F

    invoke-static {v12, v1, v11, v13}, Lo4/a;->a(Lo4/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Ll4/i;->d()J

    move-result-wide v4

    iget-object v0, v10, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;

    invoke-virtual {v0}, Ll4/h;->f()J
    ...
    :goto_0
    invoke-virtual {v14, v10}, Ll4/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v10}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v12}, Lo4/a;->b(Lo4/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_2
    sget-object p3, Ll4/e;->b:Landroid/util/Property;
    ...
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ll4/h;

    const-string p4, "iconFade"

    invoke-virtual {p2, p4}, Ll4/h;->e(Ljava/lang/String;)Ll4/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Ll4/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lo4/d;Landroid/graphics/drawable/Drawable;)V
...
.method private c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v5, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {p0, v1, v2, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ll4/j;)F

    move-result v5

    iget-object v6, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ll4/j;

    invoke-direct {p0, v1, v2, v6}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ll4/j;)F

    move-result v1

    invoke-direct {p0, v5, v1, v3, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ll4/i;Ll4/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v11, v13}, Ll4/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v12, v14}, Ll4/i;->a(Landroid/animation/Animator;)V
...
.method private d0(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroidx/core/view/u;->q(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method protected J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Ll4/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V

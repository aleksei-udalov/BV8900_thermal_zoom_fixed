...
.field private final f:La5/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILa5/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:La5/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {p0, p1, v1}, Lx4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, La5/k;->b(Landroid/content/Context;II)La5/k$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILa5/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:La5/k;

    invoke-virtual {v0, v2}, La5/g;->setShapeAppearanceModel(La5/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:La5/k;

    invoke-virtual {v1, v2}, La5/g;->setShapeAppearanceModel(La5/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, La5/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/u;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

...
.method private A(FFFI)La5/g;
    .locals 1

    invoke-static {}, La5/k;->a()La5/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, La5/k$b;->A(F)La5/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, La5/k$b;->E(F)La5/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, La5/k$b;->s(F)La5/k$b;

    move-result-object p1

    invoke-virtual {p1, p2}, La5/k$b;->w(F)La5/k$b;
    ...
    invoke-static {p0, p3}, La5/g;->m(Landroid/content/Context;F)La5/g;
    ...
    invoke-virtual {p0, p1, p4, p1, p4}, La5/g;->Y(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/d;->m:La5/g;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/d;->l:Landroid/graphics/drawable/StateListDrawable;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()La5/g;

    move-result-object v1

    sget v2, Lk4/b;->g:I

    invoke-static {p1, v2}, Lq4/a;->c(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILa5/g;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILa5/g;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILa5/g;)V
    .locals 4
    ...
    invoke-static {p2, p0, v0}, Lq4/a;->f(IIF)I
    ...
    sget-boolean p0, Lcom/google/android/material/textfield/d;->q:Z
    ...
    invoke-static {p1, p2}, Landroidx/core/view/u;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, La5/g;->C()La5/k;

    move-result-object v3

    invoke-direct {p0, v3}, La5/g;-><init>(La5/k;)V

    new-instance v3, Landroid/content/res/ColorStateList;

    invoke-direct {v3, p3, v1}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {p0, v3}, La5/g;->W(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1}, Landroidx/core/view/u;->E(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroidx/core/view/u;->D(Landroid/view/View;)I
    ...
    invoke-static {p1, p0}, Landroidx/core/view/u;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p2, p3, p4, v0}, Landroidx/core/view/u;->x0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILa5/g;)V
    .locals 6

    sget p0, Lk4/b;->k:I

    invoke-static {p1, p0}, Lq4/a;->c(Landroid/view/View;I)I
    ...
    invoke-static {p2, p0, v1}, Lq4/a;->f(IIF)I
    ...
    invoke-virtual {v0, v5}, La5/g;->W(Landroid/content/res/ColorStateList;)V

    sget-boolean v2, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v2, :cond_0

    invoke-virtual {v0, p0}, La5/g;->setTint(I)V
    ...
    invoke-direct {p2, p3}, La5/g;-><init>(La5/k;)V

    const/4 p3, -0x1

    invoke-virtual {p2, p3}, La5/g;->setTint(I)V
...
.method private varargs z(I[F)Landroid/animation/ValueAnimator;
    ...
    sget-object v0, Ll4/a;->a:Landroid/animation/TimeInterpolator;
...
.method a()V
    ...
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)La5/g;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)La5/g;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:La5/g;
